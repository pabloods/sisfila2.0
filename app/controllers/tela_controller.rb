class TelaController < ApplicationController
  ...
  def posicao_aluno
    ...
    if @aluno == nil
     return render :file => "#{Rails.root}/public/matriculanaoencontrada.html",  layout: false, status: :not_found
     # return render status: 405, json: "Matricula não encontrada ou inexistente!" 
    end
